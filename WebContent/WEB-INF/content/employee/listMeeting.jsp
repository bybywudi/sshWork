...
<%--  <tr bgcolor="#e1e1e1" >
  ...
  <tr class="pt11" height="45">
	<td><b><a href="employeeListMeetingByMgrId.action?currentpage=1&pagesize=10">历史会议</a></b></td>
	<td><b><a href="employeeListMeetingBefore.action?currentpage=1&pagesize=10">进行中的会议</a></b></td>
  </tr>--%>
  <tr class="pt11" height="45">
	<td><b>会议标题</b></td>
	<td><b>报告人</b></td>
...
<s:if test="pb.list != null">
		...
		<s:if test="pb.currentpage != 1">
			<a href="employeeListMeetingByMgrId.action?currentpage=<s:property value="pb.previouspage"/>&pagesize=10">上一页&nbsp;</a>
		</s:if>
...
<%-- 		</s:iterator> --%>
			...
			<a href="employeeListMeetingByMgrId.action?currentpage=<s:property value="pb.nextpage"/>&pagesize=10">下一页&nbsp;</a>
			</s:if>
	...
	function gotopage(pagenum,oldvalue,totalpage){
		if(pagenum<=0 || pagenum!=parseInt(pagenum)){
			...
			if(pagenum>totalpage){
				...
				//var pagesize = 10;			
				window.location.href = 'employeeListMeetingByMgrId.action?currentpage=' + pagenum + '&pagesize=10';
			}
		}
}
</script>
